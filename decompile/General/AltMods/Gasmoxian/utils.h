...
enum ITEMS {
	ITEM_TURBO_BOOST = 0,
	ITEM_BOWLING_BOMB = 1,
	ITEM_TRACKING_MISSILE = 2,
	ITEM_EXPLOSIVE_CRATE = 3,
	ITEM_N_BRIO_BEAKER = 4,
	ITEM_SPRING = 5,
	ITEM_POWER_SHIELD = 6,
	ITEM_MASK = 7,
	ITEM_N_TROPY_CLOCK = 8,
	ITEM_WARP_ORB = 9,
	ITEM_BOWLING_BOMB_X3 = 10, //A
	ITEM_TRACKING_MISSILE_X3 = 11, //B
	ITEM_INVISIBILITY = 12, //C
