...
unsigned char relic_color = BLACK;

//set custom colors for ctr race flag
unsigned char raceflag_dark_color = RED; //dark tiles
...
//this is to unlock doors, swapping the solid texture with a transparent one
unsigned short invisible_texture_blockID = 157;

//when some warp pad is locked it will display this texture
unsigned short locked_warppad_texture_blockID = 158;
...
unsigned short warp_pad4_blockID =	2;
unsigned short boss1_blockID =	1;

unsigned short door_1 = 405;
//
...
unsigned short warp_pad13_blockID =	610;
unsigned short boss4_blockID =	609;

unsigned short door_4 = 348;
//
