...
u_int CTR_main()
{
	...
	do
	{
		...
		case 0:
			...
			//keep the bosses at the end
			unsigned short warppad_blockID[MAX_TRACKS] = {warp_pad1_blockID, warp_pad2_blockID, warp_pad3_blockID, warp_pad4_blockID, warp_pad5_blockID,
			warp_pad6_blockID, warp_pad7_blockID, warp_pad8_blockID, warp_pad9_blockID, warp_pad10_blockID, warp_pad11_blockID,
			warp_pad12_blockID, warp_pad13_blockID, warp_pad14_blockID, warp_pad15_blockID, warp_pad16_blockID, warp_pad17_blockID,
			warp_pad18_blockID, warp_pad19_blockID, warp_pad20_blockID, warp_pad21_blockID, boss1_blockID,
			boss2_blockID, boss3_blockID, boss4_blockID, boss5_blockID, boss6_blockID};
			
			for (unsigned char w = 0; w < MAX_TRACKS; w++)
			{
				warppad_id[w] = warppad_blockID[w];
			}
		...
		case 3:
			...
			//change main menu strings and update level config
			void adventure_main();
			adventure_main();
...
#define BIGPATH rdata.s_PathTo_Bigfile
	...
	LOAD_LangFile((int)sdata->ptrBigfile1, g_language);
