...
int LOAD_TenStages(struct GameTracker* gGT, int loadingStage, struct BigHeader* bigfile)
{
    ...
    //just for human read purposes
    #define CUSTOM_HUB_ 1
	
	unsigned char vrm_array[MAX_TRACKS + CUSTOM_HUB_] = { COVE_VRM, TUBES_VRM, MCAVES_VRM, SKROCK_VRM, SEWER_VRM, SLIDEC_VRM,
	TEMPLE_VRM, CPARK_VRM, PPYRAMID_VRM, RAMPAGER_VRM, DCANYON_VRM, BBLUFF_VRM, DMINES_VRM, POLARP_VRM, ROCKYR_VRM, TINYA_VRM,
	NGLABS_VRM, CTCASTLE_VRM, HTSKYWAY_VRM, NITRO_COURT_VRM, OXSTATION_VRM, BOSS1_VRM, TURBOT_VRM, BOSS2_VRM, BOSS3_VRM, BOSS4_VRM, BOSS5_VRM, CUSTOM_HUB_VRM };

	unsigned char lev_array[MAX_TRACKS + CUSTOM_HUB_] = { COVE_LEV, TUBES_LEV, MCAVES_LEV, SKROCK_LEV, SEWER_LEV, SLIDEC_LEV,
	TEMPLE_LEV, CPARK_LEV, PPYRAMID_LEV, RAMPAGER_LEV, DCANYON_LEV, BBLUFF_LEV, DMINES_LEV, POLARP_LEV, ROCKYR_LEV, TINYA_LEV,
	NGLABS_LEV, CTCASTLE_LEV, HTSKYWAY_LEV, NITRO_COURT_LEV, OXSTATION_LEV, BOSS1_LEV, TURBOT_LEV, BOSS2_LEV, BOSS3_LEV, BOSS4_LEV, BOSS5_LEV, CUSTOM_HUB_LEV };
	...
	case 0:
	{
		...
		else if (levelID >= GEM_STONE_VALLEY && current_track != CUSTOM_HUB)
		{
